...
public class Messages {
    ...
    public final static String BLACK_CARD = Colors.BG_BLACK + Colors.WHITE + " Black Card " + Colors.BG_RESET + Colors.RESET;
    ...
    public final static String CZAR_TURN_MESSAGE = Colors.PURPLE + "You are the Czar. Wait for other players to play a White Card..." + Colors.RESET;
    public final static String CZAR_TURN_CHOOSE = Colors.PURPLE + "Which one is the funniest?" + Colors.RESET;
